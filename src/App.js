...
showData = (convos) => {   //this was unnecessary as we can simply pass json data into convoarray from api fetch
   let convoArray = []
    ...
    return (
      <div className="container">
        ...
        <ChatList
          ...
          editChat={this.editChat}//prior miss info caused error on handlesubmit event
